...
const navigation = [
  ...
  { name: "Achats", href: "/rh/achats", icon: ClipboardList, roles: ["admin", "responsable_rh"] },
  { name: "Demandes", href: "/rh/demandes", icon: ClipboardList, roles: ["admin", "responsable_rh"] },
  ...
  { name: "Validations Coordo", href: "/cordinator/ValidationsCoordo", icon: ClipboardList, roles: ["coordinateur", "admin"] },
