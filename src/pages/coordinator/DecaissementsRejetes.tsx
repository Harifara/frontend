...
export default function DecaissementsRejetes() {
  ...
  useEffect(() => {
    financeApi.getDecaissements().then(res => {
      ...
      setData(list.filter((d: any) => d.statut === "rejete"));
      setLoading(false);
    });
  }, []);
  ...
  return (
    <div className="p-8 space-y-6">
      <h1 className="text-3xl font-bold">Décaissements rejetés</h1>

      <Card>
        <CardHeader><CardTitle>Rejetés</CardTitle></CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
              <TableRow>
